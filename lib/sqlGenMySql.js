...
exports.composeQuery = function composeQuery(eDef, q, p)  {
	var  sql = composeQ( eDef, q, p );
	if (sql.length > 0)
		sql += _NL + 'LIMIT 1;';
	else
		sql += ';';
...
exports.composeList = function composeList(eDef, q, p, range)  {
	var  sql = composeQ( eDef, q, p );
